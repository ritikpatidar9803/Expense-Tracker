          ...
          <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="max-width:600px;width:100%;background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 6px rgba(0,0,0,0.08);">
            ...
            <tr>
              <td style="padding:20px 24px;text-align:center;background:#ffffff;">
                <!-- If you have a logo -->
                <img src="https://play-lh.googleusercontent.com/I980hdC-0pHm9erEWuYc6eRs7t_IrPamzcGe4hFM7-An9avL2Pskg-c_WYaeWZSel-1IyNmznK5qUei4H5vAGg" alt="Expense" width="120" style="max-width:120px;height:auto;border:0;display:block;margin:0 auto 8px;" />
